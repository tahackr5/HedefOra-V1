...
| R-016 | Private GitHub planında hosted CodeQL/Dependency Review yerine exact pinned OSS SAST ve all-scope dependency gate'i henüz yok | Medium | High | W001 runtime davranışından önce fail-closed OSS SAST + pnpm/Go all-scope vulnerability/license gate; scanner/rules/advisory DB digest ve negatif fixture kanıtı | Orchestrator/Security | OPEN |
