...
- Yeni exact runtime seal üzerinde local full-tree/Gitleaks/R-016/security/cold ve PR #4 trusted-base R-016/Dependency Review/CodeQL sonuçları henüz `NOT_RUN`; eski `ccb345dd` veya `ecf71c0` sonuçları yeni SHA'ya taşınmaz. VPS/SSH/DNS/Cloudflare mutation yapılmadı.
