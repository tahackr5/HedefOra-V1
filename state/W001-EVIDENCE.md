...
### T04B/T04C runtime dependency preflight — BLOCKED_EXTERNAL
...
- `oapi-codegen`, runtime ve nethttp middleware manifest/lock/tool directive'ine eklenmedi ve çağrılmayacaktır. TypeScript consumer parity ayrı task/gate'tir; public HTTP behavior T04D tamamlanmadan runtime `PASS` değildir. VPS/SSH/DNS/Cloudflare mutation yoktur.
